using static SDL.NET.SDL_ArrayOrder;
using static SDL.NET.SDL_BitmapOrder;
using static SDL.NET.SDL_PackedLayout;
using static SDL.NET.SDL_PackedOrder;
using static SDL.NET.SDL_PixelType;
